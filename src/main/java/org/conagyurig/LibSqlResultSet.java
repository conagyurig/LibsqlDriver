...
import org.conagyurig.protocol.response.Cell;
import org.conagyurig.protocol.response.Column;
...
public class LibSqlResultSet implements ResultSet {
    ...
    public LibSqlResultSet(Result result) {
    ...
    private <T> T extractValue(Cell cell, Function<String, T> parser, String columnType) throws SQLException {
        wasNull = (cell == null || cell.getValue() == null);
        if (wasNull) return null;
        try {
            return parser.apply(cell.getValue());
        } catch (Exception e) {
            throw new SQLException("Cannot convert value '" + cell.getValue() + "' to " + columnType, e);
        }
    }

    private Cell getCell(int columnIndex) throws SQLException {
    ...
    public ResultSetMetaData getMetaData() throws SQLException {
        return new LibSqlResultSetMetaData(this);
    }
    ...
    public String getString(int columnIndex) throws SQLException {
        ...
        return extractValue(cell, (val) -> val, "string");
    }

    @Override
    public int getInt(int columnIndex) throws SQLException {
        Cell cell = getCell(columnIndex);
        Integer value = extractValue(cell, Integer::parseInt, "int");
    ...
    public boolean getBoolean(int columnIndex) throws SQLException {
        Cell cell = getCell(columnIndex);
        Boolean value = extractValue(cell, Boolean::parseBoolean, "boolean");
    ...
    public boolean getBoolean(String columnLabel) throws SQLException {
        Cell cell = getCell(columnLabel);
        Boolean value = extractValue(cell, Boolean::parseBoolean, "booelan");
        return value != null;
    }
    ...
    public int getInt(String columnLabel) throws SQLException {
        Cell cell = getCell(columnLabel);
        Integer val = extractValue(cell, Integer::parseInt, "int");
